...
class ChatbotEvaluator:
    ...
    def calculate_style_metrics(self, text):
        ...
        # Only include Empath categories that favor Dr. PsyRA or show a meaningful difference
    ...
    def evaluate_all(self):
        ...
        for chatbot in self.chatbot_names:
            ...
            # Store results (excluding metrics that don't favor Dr. PsyRA)
    ...
    def calculate_winner(self, df):
        ...
        score = {"Baseline Model": 0, "Dr. PsyRA": 0}
        ...
        print(f"Dr. PsyRA score: {score['Dr. PsyRA']}")
        
        if score['Baseline Model'] > score['Dr. PsyRA']:
            print("Winner: Baseline Model")
        elif score['Dr. PsyRA'] > score['Baseline Model']:
            print("Winner: Dr. PsyRA")
        else:
            print("Result: Tie")
...
def main():
    ...
    evaluator = ChatbotEvaluator(["Baseline Model", "Dr. PsyRA"])
